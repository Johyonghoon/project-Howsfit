...
class ShowAction(InferenceAction):
    ...
    def execute_on_outputs(
        ...
        #out_fname = 'C:/project/backend/app/custom/image-densepose/' + image_fpath.split('\\')[-1]
        #out_dir = 'C:/project/backend/app/custom/image-densepose/'
        out_fname = 'data/test/image-densepose/' + 'test_1.jpg'
